<div class="max-w-5xl grow dark:text-neutral-200">
    <div
        class="flex flex-col rounded-sm bg-white text-neutral-800 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700 dark:text-neutral-50 print:break-before-page">
        {{-- card header --}}
        <div
        ...
        <div class="grid grid-cols-1 gap-5 p-2">
            @foreach ($activities as $activity)
                <div
                    class="block rounded-sm bg-neutral-200 p-3 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-600">
