<div
    class="flex flex-col justify-end rounded-sm bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700 dark:text-neutral-200 min-w-40">
    {{-- image --}}
    <div class="p-2">
