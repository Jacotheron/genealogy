            ...
            <div>
                ...
                <div class="mb-3">
                    <x-ts-textarea
                        id="source"
                        wire:model="source"
                        label="{{ __('person.source') }} :"
                        placeholder="{{ __('person.source_hint') }}"
                        maxlength="1024"
                        count
                        autofocus
                    />
                ...
                <div class="mb-3">
                    <x-ts-date
                        wire:model="source_date"
                        id="source_date"
                        label="{{ __('person.source_date') }} :"
                        format="YYYY-MM-DD"
                        :max-date="now()"
                    ...
                    <x-ts-card>
                        ...
                        <x-slot:footer>
                            <div class="flex w-full items-center justify-between">
                                ...
                                {{-- Right side --}}
                                <div class="flex items-center gap-2">
                                    <span class="min-w-10 text-center text-sm leading-none font-semibold">{{ strtoupper($file_type) }}</span>
