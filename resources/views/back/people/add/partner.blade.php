@section('title')
    &vert; {{ __('person.add_relationship') }}
@endsection
...
<x-app-layout>
    ...
    <div class="w-full space-y-5 overflow-x-auto p-2">
        <div class="flex flex-wrap gap-5">
            <div class="flex min-w-100 grow flex-col gap-5 md:max-w-max">
            ...
            <div class="flex min-w-100 grow flex-col gap-5 overflow-x-auto md:max-w-max">
                <livewire:people::add.partner :person="$person" />
            </div>
        </div>
    </div>
</x-app-layout>
